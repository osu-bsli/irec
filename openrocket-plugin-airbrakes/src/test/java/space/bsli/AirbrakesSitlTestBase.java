...
abstract class AirbrakesSitlTestBase {
    ...
    /* Transient piston-effect baro error (metres per %/s of actuator motion).
       Sloppily empirically derived from Nomad test flight 1 data. */
    static final double PISTON_EFFECT_M_PER_PCT_PER_SEC = 4.38900;
