...
pub const PFNGLVERTEXPOINTEREXTPROC = ?*const fn (size: GLint, @"type": GLenum, stride: GLsizei, count: GLsizei, pointer: ?*const GLvoid) callconv(.c) void;
pub const PFNGLNORMALPOINTEREXTPROC = ?*const fn (@"type": GLenum, stride: GLsizei, count: GLsizei, pointer: ?*const GLvoid) callconv(.c) void;
pub const PFNGLCOLORPOINTEREXTPROC = ?*const fn (size: GLint, @"type": GLenum, stride: GLsizei, count: GLsizei, pointer: ?*const GLvoid) callconv(.c) void;
pub const PFNGLINDEXPOINTEREXTPROC = ?*const fn (@"type": GLenum, stride: GLsizei, count: GLsizei, pointer: ?*const GLvoid) callconv(.c) void;
pub const PFNGLTEXCOORDPOINTEREXTPROC = ?*const fn (size: GLint, @"type": GLenum, stride: GLsizei, count: GLsizei, pointer: ?*const GLvoid) callconv(.c) void;
pub const PFNGLEDGEFLAGPOINTEREXTPROC = ?*const fn (stride: GLsizei, count: GLsizei, pointer: [*c]const GLboolean) callconv(.c) void;
pub const PFNGLGETPOINTERVEXTPROC = ?*const fn (pname: GLenum, params: [*c]?*GLvoid) callconv(.c) void;
pub const PFNGLARRAYELEMENTARRAYEXTPROC = ?*const fn (mode: GLenum, count: GLsizei, pi: ?*const GLvoid) callconv(.c) void;
pub const PFNGLDRAWRANGEELEMENTSWINPROC = ?*const fn (mode: GLenum, start: GLuint, end: GLuint, count: GLsizei, @"type": GLenum, indices: ?*const GLvoid) callconv(.c) void;
pub const PFNGLADDSWAPHINTRECTWINPROC = ?*const fn (x: GLint, y: GLint, width: GLsizei, height: GLsizei) callconv(.c) void;
pub const PFNGLCOLORTABLEEXTPROC = ?*const fn (target: GLenum, internalFormat: GLenum, width: GLsizei, format: GLenum, @"type": GLenum, data: ?*const GLvoid) callconv(.c) void;
pub const PFNGLCOLORSUBTABLEEXTPROC = ?*const fn (target: GLenum, start: GLsizei, count: GLsizei, format: GLenum, @"type": GLenum, data: ?*const GLvoid) callconv(.c) void;
pub const PFNGLGETCOLORTABLEEXTPROC = ?*const fn (target: GLenum, format: GLenum, @"type": GLenum, data: ?*GLvoid) callconv(.c) void;
...
pub const APIENTRY = @compileError("unable to translate C expr: unexpected token '__stdcall'"); // C:\Users\ianb5\Desktop\Github\irec\DVAP\lib\GLFW\include\\GLFW/glfw3.h:123:11
...
pub const GL_COLOR_TABLE_FORMAT_EXT = __helpers.promoteIntLiteral(c_int, 0x80D8, .hex);
pub const GL_COLOR_TABLE_WIDTH_EXT = __helpers.promoteIntLiteral(c_int, 0x80D9, .hex);
pub const GL_COLOR_TABLE_RED_SIZE_EXT = __helpers.promoteIntLiteral(c_int, 0x80DA, .hex);
pub const GL_COLOR_TABLE_GREEN_SIZE_EXT = __helpers.promoteIntLiteral(c_int, 0x80DB, .hex);
pub const GL_COLOR_TABLE_BLUE_SIZE_EXT = __helpers.promoteIntLiteral(c_int, 0x80DC, .hex);
pub const GL_COLOR_TABLE_ALPHA_SIZE_EXT = __helpers.promoteIntLiteral(c_int, 0x80DD, .hex);
pub const GL_COLOR_TABLE_LUMINANCE_SIZE_EXT = __helpers.promoteIntLiteral(c_int, 0x80DE, .hex);
pub const GL_COLOR_TABLE_INTENSITY_SIZE_EXT = __helpers.promoteIntLiteral(c_int, 0x80DF, .hex);
...
pub const GL_MAX_ELEMENTS_VERTICES_WIN = __helpers.promoteIntLiteral(c_int, 0x80E8, .hex);
pub const GL_MAX_ELEMENTS_INDICES_WIN = __helpers.promoteIntLiteral(c_int, 0x80E9, .hex);
...
pub const GLFW_VERSION_REVISION = @as(c_int, 1);
...
pub const GLFW_UNLIMITED_MOUSE_BUTTONS = __helpers.promoteIntLiteral(c_int, 0x00033006, .hex);
