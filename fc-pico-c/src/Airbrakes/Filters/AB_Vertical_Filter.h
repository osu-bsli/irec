...
//Takes the calculation variables, current state, and new accelerometer data from the inputs struct and 
...
//Takes the calculation variables, current state, and new barometer data from the inputs struct and computes 
//the update step
...
//Takes the calculation variables, current state, and new gps data from the inputs struct and computes 
//the update step
