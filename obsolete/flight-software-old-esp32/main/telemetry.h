...
struct __attribute__((packed)) log_packet_v3 {
    ...
    float bm1422_magn_x; // BM1422 Magnetic Field X (unit: μT)
    float bm1422_magn_y; // BM1422 Magnetic Field Y (unit: μT)
    float bm1422_magn_z; // BM1422 Magnetic Field Z (unit: μT)
    float gps_lat; // Latitude  (unit: degrees)
